...
![Welcome](https://raw.githubusercontent.com/X-RayLuan/ClawLite-Brand-Installer/main/docs/screenshots/welcome.png)
![Environment Check](https://raw.githubusercontent.com/X-RayLuan/ClawLite-Brand-Installer/main/docs/screenshots/env-check.png)
![Done](https://raw.githubusercontent.com/X-RayLuan/ClawLite-Brand-Installer/main/docs/screenshots/done.png)

## Try it out

- **Download**: [macOS (.dmg)](https://github.com/X-RayLuan/ClawLite-Brand-Installer/releases/latest/download/clawlite.dmg) | [Windows (.exe)](https://github.com/X-RayLuan/ClawLite-Brand-Installer/releases/latest/download/clawlite-setup.exe)
- **GitHub**: [github.com/X-RayLuan/ClawLite-Brand-Installer](https://github.com/X-RayLuan/ClawLite-Brand-Installer)
