...
git clone https://github.com/X-RayLuan/ClawLite-Brand-Installer.git
cd clawlite
...
Use the [bug report template](https://github.com/X-RayLuan/ClawLite-Brand-Installer/issues/new?template=bug_report.md) to file a bug. Include:
...
Use the [feature request template](https://github.com/X-RayLuan/ClawLite-Brand-Installer/issues/new?template=feature_request.md).
...
- Open a [GitHub Discussion](https://github.com/X-RayLuan/ClawLite-Brand-Installer/discussions)
- Check existing [issues](https://github.com/X-RayLuan/ClawLite-Brand-Installer/issues)
